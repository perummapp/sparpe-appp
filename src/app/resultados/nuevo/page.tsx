    ...
    <div className="min-h-screen bg-[#0d0d0d] flex items-center justify-center p-6">
      <div className="w-full max-w-sm bg-[#161616] border border-[#262626] rounded-2xl p-8">
        ...
        <form onSubmit={handleGuardar}>
          ...
          <p className="text-xs text-[#6b6b6b] -mt-3 mb-4">Solo se muestran cuentas registradas como &quot;busco sparring&quot;. Si tu rival no aparece, aún no está registrado así en la plataforma.</p>
