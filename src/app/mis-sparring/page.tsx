      ...
      <div className="max-w-md mx-auto">
        ...
        {historial.length === 0 && (
          <p className="text-sm text-muted">
            ...
            <Link href="/solicitudes" className="text-accent-light hover:underline">Solicitudes</Link>, va a aparecer aquí.
          </p>
        )}
        ...
        <div className="space-y-3">
          {historial.map((h) => {
            ...
            return (
              <div key={h.id} className="card-surface rounded-xl p-4">
